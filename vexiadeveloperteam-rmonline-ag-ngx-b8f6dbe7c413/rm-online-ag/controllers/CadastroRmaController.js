function cadastroRmaServ($scope, loading, RmaService, ObterSaldoRmMaterialService, ObterAprovadoresRmMaterialService,
    ...
    $scope.listaIdiomas = CarregaComboIdiomas(Combo);
    ...
    $scope.atualizarIdioma = function(idioma , centro , area) {
        if (idioma) {


            var centrosFiltrados = centro.filter(function(item) {
                return item.idioma === idioma.codigo;
            });
    
            // Filtra o array area com base no idioma.codigo
            var areasFiltradas = area.filter(function(item) {
                return item.idioma === idioma.codigo;
            });
    
            // Agora você pode usar centrosFiltrados e areasFiltradas conforme necessário
            console.log('Centros filtrados:', centrosFiltrados);
            console.log('Áreas filtradas:', areasFiltradas);

            $scope.centrosFiltrados = centrosFiltrados;
            $scope.areasFiltradas = areasFiltradas;
        }
    }
    ...
    $scope.novo = function() {
        ...
        $scope.atualizarIdioma($scope.objSelecionado.rm.centro);
    };

...
public class RmaService {
    ...
    private static final Logger LOG = Logger.getLogger(RmaService.class);

    public RmaService() {
    }

    public RmaService(HttpServletRequest request) {
    ...
    public CadastroRmVo listarCadastroRmVo(Rm rm) {
        ...
        try {
            ...
            if (rmVo.getRm() != null) {
                ...
                rmVo.setRmMateriais(listarRmMateriais(rm));
                rmVo.setRmDepositos(listarRmDepositos(rm));
            }
    ...
    public CadastroRmVo listarCadastroRmVoById(Integer rmId) {
        ...
        try {
            ...
            if (rmVo.getRm() != null) {
                ...
                rmVo.setRmMateriais(listarRmMateriaisByRm(rmVo.getRm()));
                rmVo.setRmDepositos(listarRmDepositos(rmVo.getRm()));
            }
    ...
    public Integer buscarNumeroRmAtual() {
        ...
        try {
            ...
            NxCriterion criterion = NxCriterion.montaRestriction(new Filtro(Rm.TIPO_RM, "MAT", Filtro.EQUAL));
            ...
            Rm rm = (Rm) genericDao.listarByFilter(propriedades, orders, Rm.class, 1, criterion).get(0);
            ...
            LOG.error(ResourceLogUtil.createMessageError(LoginService.getUsuarioLogado(request).getNome(), this.getClass().getName(), Util.getNomeMetodoAtual(), e));
            throw new RuntimeException("Erro ao tentar verificar ultimo numero rm");
        }
    ...
    public List<RmMaterial> listarRmMateriais(NxCriterion nxCriterion, List<NxOrder> orders) {
        ...
        try {
            ...
            propriedades.add(new Propriedade(RmMaterial.NOTA));
...
//                                }
    ...
    private VwRmMaterial selectVwRmMaterial(RmMaterial rmMaterial) {
        ...
        try {
            ...
            propriedades.add(new Propriedade(RmMaterial.NOTA, RmMaterial.class, aliasRmMaterial));

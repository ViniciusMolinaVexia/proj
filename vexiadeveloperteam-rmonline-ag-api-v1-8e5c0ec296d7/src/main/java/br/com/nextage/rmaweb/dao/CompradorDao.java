...
public class CompradorDao {
    ...
    /**
     * Método que realiza a inserção de um novo comprador.
     *
     * <br>
     * <br>
     * <b>Autor:</b> Felipe.
     ...
     *
     * @param obj - Comprador
     * @return objSalvo - String
     * @throws Exception - Exception
     */
    public String persist(Comprador obj) throws Exception {
    ...
    /**
     * Método que realiza a atualização dos dados de um comprador.
     * <br>
     * <br>
     * <b>Autor:</b> Felipe.
     * <b>Data:</b> 15/03/2011
     ...
     * @throws Exception - Exception
     */
    public String update(Comprador obj) throws Exception {
        Session session = HibernateUtil.getSessionFactory().getCurrentSession();
        Transaction trx = null;
        Object objSalvo = new Object();
        try {

...
public class MaterialDao {
     ...
     */
    public String persist(Material obj) throws Exception {
    ...
    /**
     * Método que realiza a atualização dos dados de um Material.
     * <br>
     * <br>
     * <b>Autor:</b> Leandro.
     * <b>Data:</b> 15/03/2011
     ...
     * @throws Exception - Exception
     */
    public String update(Material obj) throws Exception {
        Session session = HibernateUtil.getSessionFactory().getCurrentSession();
        Transaction trx = null;
        Object objSalvo = new Object();
        try {

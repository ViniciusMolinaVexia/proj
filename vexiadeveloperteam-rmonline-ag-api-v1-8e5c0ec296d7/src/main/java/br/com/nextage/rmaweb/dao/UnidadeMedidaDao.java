...
public class UnidadeMedidaDao {
     ...
     * <br>
     *
     * @param obj - TipoRequisicao
     * @return objSalvo.toString - String
     * @throws Exception - Exception
     */
    public String persist(UnidadeMedida obj) throws Exception {
    ...
    /**
     * Método que realiza a atualização dos dados de uma UnidadeMedida.
     * <br>
     * <br>
     * <b>Autor:</b> Leandro.
     * <b>Data:</b> 15/03/2011
     ...
     * @throws Exception - Exception
     */
    public String update(UnidadeMedida obj) throws Exception {
        Session session = HibernateUtil.getSessionFactory().getCurrentSession();
        Transaction trx = null;
        Object objSalvo = new Object();
        try {
            ...
            objSalvo = obj.getUnidadeMedidaId();

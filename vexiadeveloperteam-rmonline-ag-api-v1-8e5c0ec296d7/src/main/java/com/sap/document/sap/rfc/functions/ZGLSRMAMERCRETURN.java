...
@XmlType(name = "ZGLS_RMA_MERC_RETURN", propOrder = {
    "codrma",
    "grpmerc",
    "item",
    "tpmsg",
...
public class ZGLSRMAMERCRETURN {

    @XmlElement(name = "COD_RMA", required = true)
    protected String codrma;
    @XmlElement(name = "GRP_MERC", required = true)
    protected String grpmerc;
    ...
    /**
     * obtem o valor da propriedade grpmerc.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define o valor da propriedade grpmerc.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setGRPMERC(String value) {
        this.grpmerc = value;
    }
